...
function updateUserBalances() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, users, fetchError, _i, users_1, user, newBalance, updateError, error_1;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, supabase
                            ...
                            .select('*')];
                case 1:
                    _a = _b.sent(), users = _a.data, fetchError = _a.error;
                    if (fetchError)
                        throw fetchError;
                    _i = 0, users_1 = users;
                    _b.label = 2;
                ...
                case 6:
                    error_1 = _b.sent();
                    console.error('Error updating user balances:', error_1.message);
                    return [3 /*break*/, 7];
